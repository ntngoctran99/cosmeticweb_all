        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Create A Product Type</li>
            </ol>
          </div>
        </div>
      </div>
        ...
        <div class="row">
          <div class="col-md-10">
            ...
            <div class="card card-info">
              <!-- form start -->
              <form id="ProductTypeCreateForm" method="POST" enctype="multipart/form-data" action="{{ route('admin.product_type.store') }}" class="form-horizontal">
                @csrf
                <div class="card-body">
