                ...
                <div class="row">
                  ...
                  <div class="col-md-4">
                    <div class="card-tools float-right">
                      <a href="{{ route('admin.supplier.create') }}" type="button" class="btn btn-outline-primary">
                ...
                <table class="table table-bordered">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="{{ route('admin.supplier.edit', $item->id) }}" class="btn btn-outline-warning btn-sm">
